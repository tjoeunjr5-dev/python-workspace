'''
크롤링
웹사이트나 인터넷상의 데이터를 자동으로 수집하는 기술
py 프로그램이 웹 페이지를 방문해서
HTML 코드 읽고, 그 안에 있는 텍스트, 링크 이미지 등의 정보를 추출하는 과정
마치 거미가 거미줄을 기어다니듯이 웹페이지들을 돌아다닌다고 해서 크롤링

가격 비교 사이트에서 여러 쇼핑몰의 가격 정보를 수집할 때
뉴스 기사나 특정 데이터를 자동으로 모을 때
데이터 분석이나 연구 목적으로 정보를 수집할 때
'''
